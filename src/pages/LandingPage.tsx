...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white">      {/* Hero Section */}      <header className="relative overflow-hidden bg-gradient-to-r from-primary to-primary-light">
        {/* Background Pattern */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-24">            <div className="flex items-center gap-3 relative z-10">
              <img 
                src="/logo_512.png" 
                alt="Cravely Logo" 
        ...
        <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center">
          ...
          >
            ...
            <p className="text-white/90 text-xl max-w-3xl mb-12 leading-relaxed">
          ...
          >
            <div className="relative">
              ...
              {/* Main Image */}
              <div className="bg-white p-3 rounded-2xl shadow-xl transform rotate-1 hover:rotate-0 transition-all duration-500">
                <img 
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="flex items-center gap-2 mb-4 md:mb-0">
                <span className="inline-flex items-center justify-center bg-primary text-white rounded-full p-2 mr-1.5 shadow-md w-10 h-10">
